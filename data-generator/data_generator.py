...
# Send this simulate data to Postgres OLTP
...
# -----------------------------
# เปิด Auto-commit Mode
# -----------------------------
'''
เปิด Auto-commit Mode เพื่อให้การเปลี่ยนแปลงในฐานข้อมูลถูกบันทึกทันทีหลังจากการ execute คำสั่ง SQL
โดยไม่ต้องเรียก commit ด้วยตนเอง
'''
...
'''
สร้าง Cursor Object
Cursor Object ใช้สำหรับส่งคำสั่ง SQL ไปยังฐานข้อมูล (PostgreSQL)
Cursor = ตัวกลางในการ execute SQL commands
'''
cur = conn.cursor()
